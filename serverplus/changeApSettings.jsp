      ...
      <div class="container">
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<div class="span6">
					 <div>
						 <h4>Change Access Point Setting</h4>
						<form method="post" action="changeApSettingsHandler.jsp" enctype="multipart/form-data" class="form-horizontal form-signin-signup" name="addExperiment" onsubmit="return(validate());">
							<input type="file" name="eventsFile" placeholder="Upload Event File" size="20" required> <br>
							
							
							 <input type="text" name="expname" placeholder="Name" required>
							<input type="text" name="location" placeholder="Location Info" required>
			...
			%>
							...
							<br>
							<input type="submit" name="startExperiment" value="Send File" class="btn btn-primary btn-large">
