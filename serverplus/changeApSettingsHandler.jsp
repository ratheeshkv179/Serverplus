	...
	if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
	  ...
	  try{ 
		 List fileItems = upload.parseRequest(request);
			...
			if(ename==null || loc==null || des==null || filename==null) response.sendRedirect("changeApSettings.jsp");
			...
			ApSettings e = new ApSettings(ename,loc,des,username,Constants.getApSettingsFile());

			//getApSettingsFile()

			System.out.println("\n changeApSettingsHandler:");
			e.print();
			

			//int result = Utils.addExperiment(e,sessionid);
			int result = Utils.addApSettings(e,sessionid); 

			if(result<0){
				System.out.print("adding changeAp Settings to database failed...");
%>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <div class="container">
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<h4> Adding AP settings to database failed...</h4>
				
				Back to <a href="changeApSettings.jsp">Send AP Setting</a>
...
<%
			...
			*/
			...
			filePath=filePath+"_ApSettings/";				//Integer.toString(e.getID()) + "/";
			...
			if (!theDir.exists()) {
				...
				File _file = new File(filePath+Constants.getApSettingsFile());
				_file.delete();
			}
		 ...
		 while ( i.hasNext () ){
			...
			if ( !fi.isFormField () ){
				...
				file = new File(filePath+Constants.getApSettingsFile());
				//file = new File(filePath + Constants.getApSettingsFile());
				fi.write( file ) ;
		 ...
		 System.out.println("changeAPSettingsHandler.jsp:[197]" + "filter value=" + filter);
		 i = fileItems.iterator();
		 int rand_number=0;
		if(filter.equals("random")){
			System.out.println("changeAPSettingsHandler.jsp:[201]" + "filter Number=" + filterNumber);
			//result = Handlers.StartRandomExperiment(e,_session,filterNumber);
			result = Handlers.StartRandomApSettings(e,_session,filterNumber);
		}
			...
			result=Handlers.StartManualApSettings(e,_session,devices);
		}
      ...
      <div class="container">
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<h4>AP Setting : could not be started due to some error</h4>
